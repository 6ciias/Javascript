function checkCaps(string) {
  ...
  checkCaps("HELLO WORLD"); // Outputs: "SHOUTING: HELLO WORLD"
 checkCaps("hello world"); // Outputs: "whispering: hello world"
checkCaps("Hello World"); // Outputs: "talking normally: Hello World"
